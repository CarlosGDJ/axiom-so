...
export default function VariableRankingChart({ data }: VariableRankingChartProps) {
        ...
        return (
             <Card>
                <CardHeader>
                    ...
                    <CardDescription>Variables con mayor impacto (positivo o negativo) en el periodo.</CardDescription>
                </CardHeader>
    ...
    const sortedData = [...data].sort((a,b) => Math.abs(b.impact) - Math.abs(a.impact)).slice(0, 10);
